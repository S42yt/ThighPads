...
const (
	DeleteTableConfirmation ConfirmationType = iota
...
type App struct {
	...
	successMsg         string
	exportLocation     int
	confirmationScreen ConfirmationType
	confirmDeleteTable uint
...
func (a *App) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case ConfirmationScreen:
		return a.updateConfirmationScreen(msg)
	}
